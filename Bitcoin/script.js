const API_KEY = '38C5UW3807BHHCQB';


const dates = [
    '2021-02-28', '2021-03-31', '2021-04-30', '2021-05-31', '2021-06-30', '2021-07-31', '2021-08-31',
    '2021-09-30', '2021-10-31', '2021-11-30', '2021-12-31', '2022-01-31', '2022-02-28', '2022-03-31',
    '2022-04-30', '2022-05-31', '2022-06-30', '2022-07-31', '2022-08-31', '2022-09-30', '2022-10-31',
    '2022-11-30', '2022-12-31', '2023-01-31', '2023-02-28', '2023-03-31', '2023-04-30', '2023-05-31',
...
async function loadMonthlyCourse() {
    ...
    for (let i = 0; i < dates.length; i++) {
        let courseEachMonth = Math.round(monthlyCourse[dates[i]]['1a. open (EUR)']);
